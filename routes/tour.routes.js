...
router.route('/tours-within/:distance/center/:latlng/unit/:unit').get(TourCtrl.getToursWithin);
...
router
    ...
    .post(AuthCtrl.protect, AuthCtrl.restrictTo('admin', 'lead-guide'), TourCtrl.createTour);
router
    .route('/:id')
    ...
    .patch(
        ...
        TourCtrl.resizeUploadTourImages,
        TourCtrl.updateTour
    )
    .delete(AuthCtrl.protect, AuthCtrl.restrictTo('admin', 'lead-guide'), TourCtrl.deleteTour);
